export const sections = [
  {
    ...
    content: [
      ...
      `Da questo connubio, in linea con i principi fondanti dell’associazione, abbiamo concepito <strong>Naturalmente Tecnologici</strong>. Unico nel suo genere è come uno strumento per far incontrare tutte le persone che abbiamo conosciuto attraverso le collaborazioni internazionali, nazionali e locali che abbiamo l’onore di poter raccontare.`,
      `Durante l’evento si susseguiranno <strong>conferenze e workshop</strong> sul tema dello <strong>sviluppo tecnologico etico e sostenibile</strong> in termini sociali ed ambientali. Saranno ospitate personalità lucane e italiane, il cui impegno spazia dall’antropologia alla sensoristica per il monitoraggio ambientale.`,
