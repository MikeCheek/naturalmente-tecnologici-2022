export const sections = [
  {
    ...
    content: [
      ...
      `Da questo connubio, a partire da febbraio, in linea con i principi fondanti dell’associazione abbiamo concepito <strong>Naturalmente Tecnologici</strong>. Unico nel suo genere è come uno strumento per far incontrare tutte le persone che abbiamo conosciuto attraverso le collaborazioni internazionali, nazionali e locali che abbiamo l’onore di poter raccontare.`,
      `Durante l’evento si susseguiranno <strong>conferenze e workshop</strong> sul tema dello sviluppo tecnologico etico e sostenibile in termini sociali ed ambientali. Saranno ospitate personalità lucane e italiane, il cui impegno spazia dall’antropologia alla sensoristica per il monitoraggio ambientale.`,
      `Racconteranno la loro storia, terranno uno speech attorno ad un tema accuratamente scelto e ragioneranno insieme ai partecipanti dell’evento su nuove possibilità di innovazione a 360°. Sarà uno spazio di condivisione aperto, senza alcun vincolo di partecipazione se non quelli dettati dalle normative di sicurezza. Ci aspettiamo la partecipazione di un centinaio di persone.`,
      `Per noi è particolarmente importante questo evento perché riponiamo in esso la <strong>speranza</strong> di riuscire a creare qualcosa che possa <strong>lasciare il segno</strong>, soprattutto a livello territoriale, cercando di <strong>catalizzare le energie</strong> di tanti ragazzi e ragazze che si sono sparse in tutta Italia <strong>rifiutando</strong> la filosofia secondo cui  “le cose giù sono più difficili e non si può fare niente”.`,
